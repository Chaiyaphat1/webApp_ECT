        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card text-dark  bg-white border-primary">
                    ...
                    <div class="card-body">
                        <form action="regiter_save.php" method="post">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <button class="btn btn-primary btn-sm" type="summit"><i class="bi bi-save2"></i>
                                        สมัครสมาชิก</button>
                                </div>
                            </div>
                        </form>

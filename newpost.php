...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card text-drak bg-white corder-info">
                    <div class="card-header bg-info text-white">ตั้งกระทู้ใหม่</div>
                    <div class="card-body">
                        <form action="newpost_save.php" method="post">
                            <div class="row mb-3">
                                <label class="col-lg-3 col-from-lable">หมวดหมู่ :</label>
                                <div class="col-lg-9">
                            ...
                            <div class="row mb-3">
                                <label class="col-lg-3 col-from-lable">หัวข้อ :</label>
                                <div class="col-lg-9">
                                    <input type="text" name="topic" class="form-control" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-lg-3 col-from-lable">เนื้อหา :</label>
                                <div class="col-lg-9">
